...
const Header = () => {
  ...
  const handleChange = (event) => {
    ...
    navigate(`/shop/${selectedCategoryId}`);
  };

  return (
    <div className="fixed top-0 h-[120px] text-[14px] bg-black  w-full bg-gradient-to-r from-custom-left to-custom-right z-50 ">
      {/* --------------------top-header--------------------- */}
      ...
      <div className="flex justify-around w-[970px] mx-auto *:text-white mt-[10px] ">
        ...
        <div className="bg-none">
          <select  className="bg-transparent *:text-black" onChange={handleChange}>
